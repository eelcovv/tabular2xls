...
2.: pip install tabular2xls --no-index --find-links <name of the wheel file> --prefix <location> -U
...
parser = argparse.ArgumentParser("Install the python tabular2xls module")
parser.add_argument("--debug", help="Give debug info", dest="log_level", default=logging.INFO,
                    const=logging.DEBUG,
                    action="store_const")
parser.add_argument("--app_name", help="Name of the module", default="tabular2xls")
